...
<div style="background-color: var(--canvas-navy-primary, #0A192F); border: 1px solid #CBD5E1; border-left: 5px solid #003366; padding: 18px 20px; margin: 20px 0; border-radius: 4px;">

<div style="background-color: var(--canvas-navy-primary, #0A192F); border: 1px solid #CBD5E1; border-left: 5px solid #003366; padding: 18px 20px; margin: 20px 0; border-radius: 4px;">

<div style="background-color: var(--canvas-navy-primary, #0A192F); border: 1px solid #CBD5E1; border-left: 5px solid #003366; padding: 18px 20px; margin: 20px 0; border-radius: 4px;">
  <h3 style="margin-top: 0; color: var(--canvas-navy-primary, #0A192F); font-size: 1.05rem; font-weight: 700;">Instructor & Facilitator Information (Canvas 1.5)</h3>
  <p style="font-size: 0.9rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 10px;">
    <strong>Lead Facilitator:</strong> Alan Pruitt &bull; Curriculum Architect &amp; Generative AI Strategist
  </p>
  <ul style="font-size: 0.86rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 12px; padding-left: 20px;">
    <li><strong>Institutional Alignment:</strong> Arizona Western College &amp; University of Arizona Yuma Campus</li>
    <li><strong>Professional Inquiries &amp; Network:</strong> <a href="https://www.linkedin.com/in/alanpruitt/" target="_blank" rel="noopener noreferrer" style="color: var(--canvas-navy-primary, #0A192F); font-weight: 600; text-decoration: underline;">Alan Pruitt on LinkedIn &rarr;</a></li>
...
<h3 style="margin-top: 0; color: var(--canvas-navy-primary, #0A192F); font-size: 1.05rem; font-weight: 700;">Accessibility & Accommodation Statement (ADA Title II / Canvas 7.2)</h3>
  <p style="font-size: 0.9rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 10px;">
  ...
  <p style="font-size: 0.88rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 0;">
...
<div style="background-color: var(--canvas-navy-primary, #0A192F); border: 1px solid #CBD5E1; border-left: 5px solid #003366; padding: 18px 20px; margin: 20px 0; border-radius: 4px;">
  <h3 style="margin-top: 0; color: var(--canvas-navy-primary, #0A192F); font-size: 1.05rem; font-weight: 700;">Workshop Pacing & Time-on-Task Guide (Canvas 1.6 • 60-Minute Architecture)</h3>
  <p style="font-size: 0.9rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 12px;">
  ...
  <div style="overflow-x: auto; margin-bottom: 8px;">
    <table style="width: 100%; border-collapse: collapse; font-size: 0.86rem; background-color: var(--canvas-navy-primary, #0A192F); border: 1px solid #cbd5e1;">
      <thead>
        <tr style="background-color: var(--canvas-navy-primary, #0A192F); color: var(--canvas-navy-primary, #0A192F); text-align: left;">
      ...
      <tbody>
        <tr>
          <td style="padding: 8px 12px; border: 1px solid #cbd5e1; font-weight: 700; color: var(--canvas-navy-primary, #0A192F);">Module 0: Pre-Flight</td>
        ...
        <tr style="background-color: var(--canvas-navy-primary, #0A192F);">
          <td style="padding: 8px 12px; border: 1px solid #cbd5e1; font-weight: 700; color: var(--canvas-navy-primary, #0A192F);">Module 1: Governance</td>
        ...
        <tr>
          <td style="padding: 8px 12px; border: 1px solid #cbd5e1; font-weight: 700; color: var(--canvas-navy-primary, #0A192F);">Module 2: Admin Relief</td>
        ...
        <tr style="background-color: var(--canvas-navy-primary, #0A192F);">
          <td style="padding: 8px 12px; border: 1px solid #cbd5e1; font-weight: 700; color: var(--canvas-navy-primary, #0A192F);">Module 3: Prompt Craft</td>
        ...
        <tr>
          <td style="padding: 8px 12px; border: 1px solid #cbd5e1; font-weight: 700; color: var(--canvas-navy-primary, #0A192F);">Module 4: Safety Audit</td>
        ...
        <tr style="background-color: var(--canvas-navy-primary, #0A192F);">
          <td style="padding: 8px 12px; border: 1px solid #cbd5e1; font-weight: 700; color: var(--canvas-navy-primary, #0A192F);">Module 5: Capstone</td>
        ...
        <tr style="font-weight: 700; background-color: var(--canvas-navy-primary, #0A192F); color: var(--canvas-navy-primary, #0A192F);">
...
<h3 style="margin-top: 0; color: var(--canvas-navy-primary, #0A192F); font-size: 1.05rem; font-weight: 700;">Step 1: Institutional Enterprise Authentication Gateway</h3>
  <p style="font-size: 0.9rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 12px;">
  ...
  <p style="margin-bottom: 14px;">
    <a href="https://google.arizona.edu" target="_blank" rel="noopener noreferrer" style="display: inline-block; background-color: var(--canvas-navy-primary, #0A192F); color: #FFFFFF !important; font-weight: 600; font-size: 0.88rem; padding: 10px 18px; border-radius: 4px; text-decoration: none;">
      Launch Institutional Workspace: google.arizona.edu &rarr;
    </a>
  </p>
  <ul style="font-size: 0.86rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 0; padding-left: 20px;">
...
<div style="background-color: var(--canvas-navy-primary, #0A192F); border: 1px solid #CBD5E1; border-left: 5px solid #003366; padding: 18px 20px; margin: 20px 0; border-radius: 4px;">
  <h3 style="margin-top: 0; color: var(--canvas-navy-primary, #0A192F); font-size: 1.05rem; font-weight: 700;">Step 2: FERPA & Sensitive Data Pre-Flight Audit</h3>
  <p style="font-size: 0.9rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 10px;">
...
<details open style="background-color: var(--canvas-navy-primary, #0A192F); border: 1px solid #cbd5e1; border-left: 4px solid #003366; border-radius: 4px; padding: 12px 16px; margin: 16px 0 24px 0;">
  <summary style="font-weight: 700; color: var(--canvas-navy-primary, #0A192F); cursor: pointer; font-size: 0.95rem; outline: none;">
    View Verified Benchmark Exemplar (Meeting Action Matrix Output)
  </summary>

<div style="margin-top: 12px; font-size: 0.88rem; color: var(--canvas-navy-primary, #0A192F); line-height: 1.5;">
...
<div style="background-color: var(--canvas-navy-primary, #0A192F); border-left: 3px solid #10b981; padding: 8px 12px; font-size: 0.82rem;">
...
<div style="background-color: var(--canvas-navy-primary, #0A192F); padding: 12px; border: 1px solid #cbd5e1; border-radius: 4px; margin-bottom: 12px;">
<h3 style="color: var(--canvas-navy-primary, #0A192F); margin: 0 0 6px 0; font-size: 0.92rem;">Formative Evaluation Summary (Rubric Score: Proficient / 18 of 20 pts)</h3>
...
<div class="roi-calculator-widget" style="background-color: var(--canvas-navy-primary, #0A192F); border: 1.5px solid #002147; border-left: 6px solid #065F46; border-radius: 6px; padding: 20px; margin: 24px 0; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
  <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 12px; flex-wrap: wrap; margin-bottom: 14px; border-bottom: 1px solid #CBD5E1; padding-bottom: 10px;">
    <div>
      <span style="background-color: var(--canvas-navy-primary, #0A192F); color: var(--canvas-navy-primary, #0A192F); font-size: 0.72rem; font-weight: 700; padding: 2px 8px; border-radius: 3px; letter-spacing: 0.05em; text-transform: uppercase;">Executive ROI Tally</span>
<h3 style="margin: 4px 0 2px 0; color: var(--canvas-navy-primary, #0A192F); font-size: 1.1rem; font-weight: 700;">Faculty Time Reclaimed Estimator</h3>
<p style="margin: 0; font-size: 0.84rem; color: var(--canvas-navy-primary, #0A192F);">Calculate institutional hours reclaimed per semester across routine administrative workflows.</p>
</div>
<div style="background-color: var(--canvas-navy-primary, #0A192F); border: 1.5px solid #003366; border-radius: 6px; padding: 10px 16px; text-align: center; min-width: 170px;">
<span style="display: block; font-size: 0.75rem; font-weight: 700; color: var(--canvas-navy-primary, #0A192F); text-transform: uppercase;">Hours Reclaimed</span>
<span id="roi-hours-total-en" aria-live="polite" style="font-size: 1.65rem; font-weight: 800; color: var(--canvas-navy-primary, #0A192F); line-height: 1.2;">16.5</span>
<span style="display: block; font-size: 0.72rem; color: var(--canvas-navy-primary, #0A192F); font-weight: 700;">hrs / semester</span>
</div>
</div>

<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 16px; margin-top: 16px;">
<div>
<label for="slider-meetings-en" style="display: flex; justify-content: space-between; font-size: 0.82rem; font-weight: 700; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 6px;">
<span>Committee Transcripts (45m/ea)</span>
<span id="val-meetings-en" style="color: var(--canvas-navy-primary, #0A192F); font-weight: 700;">6</span>
</label>
<input type="range" id="slider-meetings-en" min="0" max="20" value="6" step="1" style="width: 100%; accent-color: var(--canvas-navy-primary, #0A192F); cursor: pointer;">
</div>

<div>
<label for="slider-rubrics-en" style="display: flex; justify-content: space-between; font-size: 0.82rem; font-weight: 700; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 6px;">
<span>Rubrics Calibrated (90m/ea)</span>
<span id="val-rubrics-en" style="color: var(--canvas-navy-primary, #0A192F); font-weight: 700;">4</span>
</label>
<input type="range" id="slider-rubrics-en" min="0" max="15" value="4" step="1" style="width: 100%; accent-color: var(--canvas-navy-primary, #0A192F); cursor: pointer;">
</div>

<div>
<label for="slider-syllabi-en" style="display: flex; justify-content: space-between; font-size: 0.82rem; font-weight: 700; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 6px;">
<span>Syllabus Audits (120m/ea)</span>
<span id="val-syllabi-en" style="color: var(--canvas-navy-primary, #0A192F); font-weight: 700;">3</span>
</label>
<input type="range" id="slider-syllabi-en" min="0" max="10" value="3" step="1" style="width: 100%; accent-color: var(--canvas-navy-primary, #0A192F); cursor: pointer;">
</div>
</div>
</div>
...
<div style="background-color: var(--canvas-navy-primary, #0A192F); border: 1px solid #CBD5E1; border-left: 5px solid #003366; padding: 18px 20px; margin: 20px 0; border-radius: 4px;">
  <h3 style="margin-top: 0; color: var(--canvas-navy-primary, #0A192F); font-size: 1.05rem; font-weight: 700;">Summative Evaluation Standards (Canvas / QM 3.1 & 3.3)</h3>
  <p style="font-size: 0.9rem; line-height: 1.6; color: var(--canvas-navy-primary, #0A192F); margin-bottom: 8px;">
...
<div style="margin: 28px 0;">
  <details style="border: 1px solid #CBD5E1; border-left: 5px solid #002147; background-color: var(--canvas-navy-primary, #0A192F); border-radius: 4px; padding: 12px 16px;">
    <summary style="font-weight: 700; color: var(--canvas-navy-primary, #0A192F); cursor: pointer; font-size: 0.95rem; user-select: none;">
      &#128221; Facilitator Desk: Instructor Monitoring & SpeedGrader Quick Guide (Click to Expand)
    </summary>

<div style="margin-top: 14px; border-top: 1px solid #E2D9C8; padding-top: 12px; font-size: 0.88rem; line-height: 1.55; color: var(--canvas-navy-primary, #0A192F);">
<p>
...
<a href="/docs/reclaiming-our-time-canvas-bundle.zip" download style="display: inline-flex; align-items: center; background-color: var(--canvas-navy-primary, #0A192F); color: #FFFFFF !important; padding: 8px 14px; border-radius: 4px; font-weight: 600; text-decoration: none; font-size: 0.82rem;">
        Download Canvas Shell Package (.imscc &amp; Rubric) &rarr;
      </a>
      <a href="/docs/reclaiming-our-time-evaluator-guide.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; background-color: var(--canvas-navy-primary, #0A192F); color: #FFFFFF !important; padding: 8px 14px; border-radius: 4px; font-weight: 600; text-decoration: none; font-size: 0.82rem;">
          Download Printable Evaluation Protocol (PDF) &rarr;
</a>
<a href="/docs/canvas-v3-audit-report.html" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; border: 1px solid #002147; color: #002147 !important; padding: 8px 14px; border-radius: 4px; font-weight: 600; text-decoration: none; font-size: 0.82rem; background-color: var(--canvas-navy-primary, #0A192F);">
          View Canvas v3.0 & QM (7th Ed) Exemplar Audit Report &rarr;
</a>
<a href="/docs/reclaiming-our-time-evaluator-guide.html" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; border: 1px solid #003366; color: #003366 !important; padding: 8px 14px; border-radius: 4px; font-weight: 600; text-decoration: none; font-size: 0.82rem; background-color: var(--canvas-navy-primary, #0A192F);">
          View Standalone Guide (HTML) &rarr;
</a>
</div>

<h3 style="color: var(--canvas-navy-primary, #0A192F); font-size: 0.92rem; margin: 14px 0 6px 0;">The 90-Second SpeedGrader Rapid Triaging Workflow:</h3>
...
## Continuing Faculty Professional Development: Google Workspace with Gemini for Education
    <strong style="color: var(--canvas-navy-primary, #0A192F); font-size: 0.95rem;">Google Workspace with Gemini for Education</strong>
  </div>
  <p style="margin: 0 0 10px 0; font-size: 0.86rem; color: var(--canvas-navy-primary, #0A192F); line-height: 1.5;">
    Explore enterprise-grade data protection, administrative automation, and curricular integration pathways for higher education faculty and staff.
  </p>
  <a href="https://edu.google.com/ai/gemini-for-education/"
     target="_blank"
     rel="noopener noreferrer"
     style="display: inline-flex; align-items: center; gap: 6px; background-color: var(--canvas-navy-primary, #0A192F); color: #FFFFFF !important; padding: 6px 12px; border-radius: 4px; font-weight: 600; font-size: 0.82rem; text-decoration: none; min-height: 40px;">
    <span>Explore Gemini for Education Portal</span>
