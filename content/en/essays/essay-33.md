...
Fall 2026 launch week is here.

Your inbox is flooded. Faculty across the course portfolio stare at glowing screens past midnight, click through three nested menus in a proprietary Canvas LMS, manually hunt down broken contrast ratios, and pray a third-party plugin doesn’t break before morning classes go live.

We have spent decades accepting this friction as the cost of doing business.

Updating course shells. Chasing down ADA Title II compliance retroactively. Adjusting to a new round of institutional software updates and starting the content grind all over again.

Getting locked into proprietary platforms is simply what you do.

Excep---

A practical look at trading proprietary WYSIWYG editors for plain-text repositories, automatory of institutional rebellion.
...
Then I looked more closely at what locking my curriculum into closed systems was actually buying me: endless remediation loops, platform lock-in, and zero true ownership of my educational assets.
...
Would another software patch solve my systemic vulnerabilities?

The Fall 2026 launch forced me to look at the other side of the equation.

What did course authoring cost me in cognitive load, time, and institutional sovereignty? And, more importantly: Did it have to cost that much?
...
Woullly changed the calculation.

Instead of accepting a closed software ecosystem and designing my courses around its limitations, I began designing my curriculum around my students' and faculty's actual needs.

I still advise, build, and audit course portfolios. If an institutional partnership or a custom deployment comes up, great.

But I no longer fight proprietary WYSIWYG editors or chase software patches to keep a Syllabus live.
...
Plenty of higher-ed tech stories on the internet are about someone who raised $50 million for an AI-powered learning management portal or automated an entire campus with a proprietary black-box algorithm.

This isn’t one of those stories.

I taught classes. I built content. I made some smart technical decisions.
...
I still have institutional accessibility standards to maintain. Version histories to track. Multi-device rendering to verify. OER compliance to guard.

The difference is that I now look at course infrastructure somewhat differently.
...
I suspect there are a lot of faculty members, instructional designers, and academic technologists asking some version of the question I found myself asking:

How many more semesters do I really need to spend fighting my own software?
...
I don’t think the answer is identical for every institution.

For me, part of the answer turned out to be stripping out the proprietary bloat, embracing Curriculum-as-Code, and learning to build semantic, WCAG-compliant learning assets using plain-text repositories.

For someone else, it might mean migrating to open-source alternatives, championing open workflows, or simply deciding that paying recurring licensing fees for bloated software isn?I suspect therer year behind a legacy interface.

Buying back instructional time.

It's been long enough since my full migration away from closed LMS authoring to see the shift in real time.
